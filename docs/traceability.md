...
automated test and any related defects. Maintained per [ISO 26262 / Automotive SPICE]
...
| CBTB-9 | Listener shall detect timeout when sender stops broadcasting | TC-003 | `tests/test_simulator.py` | `test_missing_message` | PASSED | — |
...
|---|---|---|---|---|---|
| CBTB-DEF-001 | Listener counted in-flight frames as post-shutdown | TC-003 | CBTB-9 | Closed | Added 1-frame slack tolerance in assertion to absorb thread scheduling jitter |